...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        logging.info("Entered get_transformer_object.")
        try:
            ...
            logging.error("Error in get_transformer_object")
            raise NetworkSecurityException(e, sys)
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info(f"Transformed train file path: {self.data_transformation_config.transformed_train_file_path}")
            logging.info(f"Type: {type(self.data_transformation_config.transformed_train_file_path)}")
